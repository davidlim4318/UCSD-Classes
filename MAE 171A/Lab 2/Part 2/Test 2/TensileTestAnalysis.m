...
legend('Data','Linear Least-Squares Approx.','Location','northeast',"FontSize",14)
ax = gca;
ax.TitleHorizontalAlignment = 'left';
set(ax,'FontSize',16)
...
legend('Data','Linear Least-Squares Approx.','Ultimate Stress','Location','northeast',"FontSize",14)
ax = gca;
ax.TitleHorizontalAlignment = 'left';
set(ax,'FontSize',16)
